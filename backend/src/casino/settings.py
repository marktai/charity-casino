...
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['http://*', 'http://localhost', 'http://localhost:7080', 'http://casino.marktai.com', 'https://casino.marktai.com']
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'casino.middleware.CsrfExemptSessionAuthentication',
    ),
